...
>_**'E'**_ : 指代公式 (2c) 中的 _**E**_；  
>_**'Di'**_ : 指代公式 (2c) 中的 _**D<sub>i</sub>**_；  
>_**'Ai'**_ : 指代公式 (2b) 中的 _**A<sub>i</sub>**_；  
>_**'Bi'**_ : 指代公式 (2b) 中的 _**B<sub>i</sub>**_；  
>_**'Qi'**_ : 指代公式 (2a) 中的 _**Q<sub>i</sub>**_；  
>_**'di'**_ : 指代公式 (2a) 中的 _**d<sub>i</sub>**_；   
>_**'ci'**_ : 指代公式 (2a) 中的 _**c<sub>i</sub>**_；
